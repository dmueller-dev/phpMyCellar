...
('rating_guide', 'Wine Rating & Evaluation Guide', '<h3>Our Rating Philosophy</h3><p>We evaluate wines using an independent 20-point scoring system and the WSET systematic approach to tasting. The aim is to assess balance, intensity, length, complexity, and ageability with transparency and consistency.</p>', 'Guide explaining our wine tasting rating scale and methodology.');
