...
| **Interactive Menu** | • Live *Carte des vins* highlighting ready-to-drink wines for guests with drinking window and private reserve indicators.<br>• Configurable unready wine visibility and interactive vintage storage popovers.<br>• Sortable by producer, vintage, variety, or style with sidebar icon legend. |
