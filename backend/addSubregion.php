    ...
    <div class="card">
      <section>
        ...
        <form method="POST" accept-charset="UTF-8">
          ...
          <input type="text" name="subregion" id="subregion" required maxlength="100" value="<?php echo htmlspecialchars($subregion, ENT_QUOTES, 'UTF-8'); ?>">
            
          <br><br>
          <label for="subregion_desc">Description:</label><br>
          <textarea name="subregion_desc" id="subregion_desc" rows="20" cols="40" maxlength="1500" placeholder="<p>...</p>"><?php echo htmlspecialchars($subregion_desc, ENT_QUOTES, 'UTF-8'); ?></textarea>
            
          <br><br>
          <input type="submit" name="update" value="Insert Subregion">
        </form>
      </section>
    </div>
  </div>
