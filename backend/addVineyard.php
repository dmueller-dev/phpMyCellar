      ...
      if (empty($errors)) {
        ...
        try {
          if (insertVineyard($conn, $vineyard, $region_id, $appellation_id, $vineyard_desc)) {
            ...
            $conn->rollback();
            $errors[] = "Error inserting vineyard";
          }
        } catch (Exception $e) {
          $conn->rollback();
    ...
    <div class="card">
      <section>
        ...
        <form method="POST" accept-charset="UTF-8">
          ...
          <br><br>
          <label for="appellation_id">Appellation (optional):</label><br>
          ...
          <input type="text" name="vineyard" id="vineyard" required maxlength="100" value="<?php echo htmlspecialchars($vineyard, ENT_QUOTES, 'UTF-8'); ?>">
            
          <br><br>
          <label for="vineyard_desc">Description:</label><br>
          <textarea name="vineyard_desc" id="vineyard_desc" rows="20" cols="40" maxlength="1500" placeholder="<p>...</p>"><?php echo htmlspecialchars($vineyard_desc, ENT_QUOTES, 'UTF-8'); ?></textarea>
            
          <br><br>
          <input type="submit" name="update" value="Insert Vineyard">
        </form>
      </section>
    </div>
  </div>
